...
export const slides = [
  ...
  },
  {
    ...
    title: 'Oh boy, \ncan I code',
    subtitle:
      'Expert in React-Native. Highly skilled at React.js, JavaScript, and Redux. Also experienced \nin Next.js, styled-components, Typescript GraphQL, and Flex-Box. Characterized by sticking\n to good practices with frameworks such as React-Testing Library, Jest and E2E testing with Cypress.',
    images: {
